...
function VolumeControl({ audioRef }) {
  ...
  return (
    <div className="flex items-center space-x-1">
      <button
        onClick={toggleMute}
        className="text-gray-300 hover:text-white focus:outline-none transition-colors p-1"
      ...
      <input
        ...
        className="slider w-16 h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer"
